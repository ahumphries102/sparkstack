          ...
          <div className="space-y-8">
            <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {backend.includedServices.map((service, index) => (
            ...
            <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {backend.useCases.map((useCase, index) => (
                  <div
                    key={index}
        ...
        {activeTab === "process" && (
          <div className="space-y-8">
            <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8">
              ...
              <div className="space-y-8">
                {backend.processSteps.map((step, index) => (
            ...
            <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {backend.timelineItems.map((item, index) => (
                  <div
                    key={index}
        ...
        {activeTab === "technologies" && (
          <div className="space-y-8">
            <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8">
              ...
              {backend.technologyCategories.map((category, index) => (
            ...
            <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8">
              ...
              <div className="space-y-6 text-zinc-300">
                {backend.technologyExplanations.map((explanation, index) => (
                  <div key={index}>
