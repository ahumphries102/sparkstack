...
import { Code, Check, ArrowRight, Database, Lock, Server, Cloud, Layers, Zap, LucideIcon } from 'lucide-react';
...
const BackEndDetailPage: React.FC = () => {
  ...
  const featureCards: FeatureCard[] = [
    {
      ...
      description: 'Design and implement scalable database schemas with PostgreSQL, MongoDB, or MySQL. Optimized queries and proper indexing.'
    },
    {
      icon: Server,
      title: 'RESTful APIs',
      description: 'Build robust, well-documented APIs that are easy to consume. Following REST best practices and industry standards.'
    },
    {
      icon: Lock,
      title: 'Security First',
      description: 'Authentication, authorization, encryption, and protection against common vulnerabilities. Your data stays safe.'
    },
    {
      icon: Cloud,
      title: 'Cloud Infrastructure',
      description: 'Deploy on AWS, Google Cloud, or Azure. Containerized with Docker, orchestrated with Kubernetes when needed.'
    },
    {
      icon: Layers,
      title: 'Microservices',
      description: 'Break monoliths into manageable services. Independent deployment, better scalability, easier maintenance.'
    },
    {
      icon: Zap,
      title: 'High Performance',
      description: 'Caching strategies, background jobs, optimized queries. Built to handle high traffic and scale with demand.'
    }
  ];
  ...
  const useCases: UseCase[] = [
    {
      ...
      description: 'Power your iOS and Android apps with reliable, fast APIs that handle authentication, data storage, and real-time updates.'
    },
    {
      title: 'SaaS Platforms',
      description: 'Build multi-tenant architectures with subscription management, user permissions, and scalable infrastructure.'
    },
    {
      title: 'E-commerce Systems',
      description: 'Handle product catalogs, inventory management, order processing, and payment integration for online stores.'
    },
    {
      title: 'Data Processing',
      description: 'Process large datasets, generate reports, and provide analytics through efficient background jobs and APIs.'
    },
    {
      title: 'IoT Applications',
      description: 'Collect, process, and store data from IoT devices. Real-time monitoring and data visualization.'
    },
    {
      title: 'Legacy Modernization',
      description: 'Replace outdated backend systems with modern, maintainable APIs that integrate with existing infrastructure.'
    }
  ];
  ...
  const processSteps: ProcessStep[] = [
    {
      ...
      description: 'Deep dive into your business logic, data models, and system requirements. We define endpoints, data flows, and technical specifications together.',
      deliverables: ['API specification document', 'Database schema design', 'System architecture diagram']
    },
    {
      number: '02',
      title: 'Architecture Design',
      description: 'Design a scalable, maintainable system architecture. Choose the right databases, define microservices boundaries, and plan for growth.',
      deliverables: ['Technical architecture document', 'Infrastructure plan', 'Security strategy']
    },
    {
      number: '03',
      title: 'Development & Testing',
      description: 'Build APIs with comprehensive test coverage. Implement business logic, integrate third-party services, and ensure everything works flawlessly.',
      deliverables: ['Working APIs', 'Test suite', 'API documentation']
    },
    {
      number: '04',
      title: 'Security Audit',
      description: 'Thorough security review and penetration testing. Implement best practices for authentication, authorization, and data protection.',
      deliverables: ['Security audit report', 'Vulnerability fixes', 'Security documentation']
    },
    {
      number: '05',
      title: 'Deployment & Monitoring',
      description: 'Deploy to production with CI/CD pipelines. Set up monitoring, alerting, and logging to ensure system health and performance.',
      deliverables: ['Production deployment', 'Monitoring dashboards', 'Operations documentation']
    }
  ];
  ...
  const technologyCategories: TechnologyCategory[] = [
    ...
    },
    {
      ...
      color: 'text-violet-400',
      technologies: ['REST', 'GraphQL', 'WebSockets', 'gRPC', 'Stripe', 'SendGrid']
    },
    {
      title: 'DevOps & Infrastructure',
      color: 'text-violet-400',
      technologies: ['Docker', 'Kubernetes', 'AWS', 'GitHub Actions', 'Nginx', 'PM2']
    },
    {
  ...
  const technologyExplanations: TechnologyExplanation[] = [
    {
      ...
      description: 'JavaScript on the server means full-stack consistency. Node.js is proven at scale (Netflix, PayPal, NASA), and Express provides a lightweight, flexible foundation for building APIs.'
    },
    {
      title: 'PostgreSQL',
      description: 'The world\'s most advanced open-source relational database. ACID compliance, complex queries, JSON support, and proven reliability for mission-critical applications.'
    },
    {
      title: 'TypeScript',
      description: 'Type safety catches errors at compile time, not in production. Better IDE support, self-documenting code, and easier refactoring as your codebase grows.'
    },
    {
      title: 'Docker & Kubernetes',
      description: 'Containerization ensures consistency across environments. Kubernetes provides orchestration, auto-scaling, and self-healing for production workloads.'
    }
  ];
        ...
        <div className="mb-16">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xl text-zinc-400">Robust server-side solutions for your applications</p>
            </div>
          </div>
        </div>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
            <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8">
              <h2 className="text-3xl font-bold mb-6">The Engine That Powers Everything</h2>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {useCases.map((useCase, index) => (
                  <div key={index} className="p-4 bg-zinc-800/50 rounded-xl border border-zinc-700">
                    <h3 className="text-lg font-bold mb-2 text-violet-400">{useCase.title}</h3>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {step.deliverables.map((deliverable, idx) => (
                          <span key={idx} className="px-3 py-1 bg-violet-400/10 border border-violet-400/20 rounded-full text-sm text-violet-400">
                            {deliverable}
                          </span>
                        ))}
                      </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {timelineItems.map((item, index) => (
                  <div key={index} className="text-center p-6 bg-zinc-800/50 rounded-xl">
                    <div className="text-4xl font-black text-violet-400 mb-2">{item.duration}</div>
            ...
            <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8">
              ...
              <div className="space-y-6 text-zinc-300">
                {technologyExplanations.map((explanation, index) => (
                  <div key={index}>
                    <h3 className="text-xl font-bold mb-2 text-violet-400">{explanation.title}</h3>
